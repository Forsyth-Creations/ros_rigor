...
def generate_launch_description():
    ...
    default_config_topics = os.path.join(get_package_share_directory('hermes_robot_description'),
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                {'use_sim_time': LaunchConfiguration('use_sim_time'), 'use_stamped': False},
