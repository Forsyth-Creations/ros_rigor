...
def generate_launch_description():
    ...
    swerve_module_a = Node(
        ...
        parameters=[{'module_name': 'swerve_a'}],  # Pass the namespace as a parameter
    )
    ...
    swerve_module_b = Node(
        ...
        namespace='swerve_b',
        output='screen',
        parameters=[{'module_name': 'swerve_b', 'invert_drive_motor': True}],  # Invert the drive motor
    )
    ...
    swerve_module_c = Node(
        ...
        namespace='swerve_c',
        output='screen',
        parameters=[{'module_name': 'swerve_c'}],
    )
    ...
    swerve_module_d = Node(
        ...
        namespace='swerve_d',
        output='screen',
        parameters=[{'module_name': 'swerve_d'}],
    )
